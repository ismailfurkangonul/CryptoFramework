...
namespace CryptoFramework
{
    internal static class Crypto
    {
        public static string Sifrele(string metin)
        {
            ...
            //sistemin kripto servisine ait class ı instance alındı.
            using (MD5CryptoServiceProvider provider = new MD5CryptoServiceProvider())
            {
                ...
                using (TripleDESCryptoServiceProvider serviceProvider = new TripleDESCryptoServiceProvider() { Key = anahtarlar, Mode = CipherMode.ECB, Padding = PaddingMode.PKCS7 })
                {
